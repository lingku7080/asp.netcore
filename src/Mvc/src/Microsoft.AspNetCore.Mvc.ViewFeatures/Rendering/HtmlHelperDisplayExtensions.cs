...
namespace Microsoft.AspNetCore.Mvc.Rendering
{
    ...
    public static class HtmlHelperDisplayExtensions
    {
        ...
        /// <typeparam name="TModel">The type of the model.</typeparam>
        /// <typeparam name="TResult">The type of the <paramref name="expression"/> result.</typeparam>
        /// <returns>A <see cref="Task"/> that on completion returns a <see cref="IHtmlContent"/> containing the created HTML.</returns>
        /// <remarks>
        /// <para>
        /// For example the default <see cref="object"/> display template includes markup for each property in the
        /// <paramref name="expression"/> result.
            ...
            string htmlFieldName = null)
        {
            ...
            if (htmlHelper is HtmlHelper<TModel> defaultHtmlHelper)
            {
                ...
                return defaultHtmlHelper.GenerateDisplayAsync(
