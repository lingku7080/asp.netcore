...
& $PSScriptRoot\build.ps1 -x64 $locationToObj\dotnetx64.zip -x86 $locationToObj\dotnetx86.zip -IsFinalBuild -BuildNumber $env:BUILD_NUMBER -SignType Real /p:MicrosoftNetCoreAppPackageVersion=2.2.0 /p:MicrosoftAspNetCoreAspNetCoreModulePackageVersion=2.2.0 /p:MicrosoftAspNetCoreAspNetCoreModuleV2PackageVersion=2.2.0
